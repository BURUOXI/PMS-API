...
from common.handbasedata import BaseData
from common.handlerandom import chinese_name, credit_card_number, set_random_pyint, random_city
...
class TestBooth(unittest.TestCase):
    excel = ReadExcel(case_file, "booth")
